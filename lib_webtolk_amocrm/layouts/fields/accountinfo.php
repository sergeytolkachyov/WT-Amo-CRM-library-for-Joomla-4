...
if ($has_error): ?>
    <div class="alert alert-danger row w-100">
        <div class="col-2 h1"><?php
            echo $amocrm_error->error_code; ?></div>
        <div class="col-10"><?php
            echo $amocrm_error->error_message; ?></div>
    </div>
<?php
else:
    ...
    <div class="row g-0 shadow w-100 p-3">
        ...
        <div class="col-12 col-md-7 col-lg-3 col-xl-4 d-flex flex-lg-column mb-3">
            ...
            <span class="me-1"><span class="badge bg-primary"><?php echo Text::_('LIB_WTAMOCRM_FIELD_ACCOUNTINFO_EMAIL'); ?>:</span> <span class="badge bg-secondary"> <?php
                echo $user_info->email; ?></span></span>
            <span class="me-1"><span class="badge bg-primary"><?php echo Text::_('LIB_WTAMOCRM_FIELD_ACCOUNTINFO_IS_ADMIN'); ?></span> <span class="badge bg-<?php echo ($user_is_admin) ? 'success' : 'warning'; ?>"><?php
                echo Text::_(($user_is_admin) ? 'JYES' : 'JNO'); ?></span></span>
